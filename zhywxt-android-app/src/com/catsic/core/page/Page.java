package com.catsic.core.page;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;

import com.catsic.core.tools.PageUtils;

/**  
  * @Description: 分页 
  * @author wuxianling  
  * @date 2014年9月15日 下午5:41:51  
  * @param <T>  
  */ 
...
public class Page<T> implements Serializable {
	...
	public List<Integer> getLinkPageNumbers() {
		return PageUtils.generateLinkPageNumbers(getThisPageNumber(), getLastPageNumber(),5);
	}
