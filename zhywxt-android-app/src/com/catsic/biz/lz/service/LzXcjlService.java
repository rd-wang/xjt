package com.catsic.biz.lz.service;
...
public class LzXcjlService extends BaseService{
	
	private ResultHandler handler = new ResultHandler();
	
	public LzXcjlService(Context context){
		super(context);
//		this.context = context;
	...
	public void operationDel(List<Map<String, Object>> listItems,boolean [] hasChecked){
		...
		if (sb.toString().indexOf(",")>0) {
			...
			db.deleteByWhere(LzXcjl.class, "crowid in "+inSql);
		}
	...
	/**  
	  ...
	  * @throws  
	  */ 
	public void save(LzXcjl lzXcjl) {
	   ...
	   params.add(new RequestParamSerializable("jsonObj",new Gson().toJson(lzXcjl)));
	...
	public void operationSB(List<Map<String, Object>> listItems,int selectID) throws JSONException {
		...
		new LzXcjlService(context).save(obj);
